...
impl RequestHandler for SimpleHandler {
    ...
    fn process_mutable_fc<T>(&mut self, value: MutableFunctionCode<T>) -> Result<MutableFunctionCode<T>, ExceptionCode> {
        tracing::info!("processing mutable function code: {}", fc);
